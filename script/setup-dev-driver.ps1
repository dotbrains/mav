...
$Volume = New-VHD -Path C:/mav_dev_drive.vhdx -SizeBytes 100GB |
                    Mount-VHD -Passthru |
...
Dismount-VHD -Path C:/mav_dev_drive.vhdx
Mount-VHD -Path C:/mav_dev_drive.vhdx
