use mav_extension_api::{
    self as mav, Architecture, DownloadedFileType, GithubReleaseOptions, Os, Result,
...
impl ProtoLs {
    ...
    pub(crate) fn language_server_binary(
        ...
        let latest_release = mav::latest_github_release(
            "coder3101/protols",
        ...
        let (os, arch) = mav::current_platform();
        ...
        mav::download_file(&download_target.download_url, &version_dir, file_type)?;
