...
| Document | Use it for |
|---|---|
| [getting-started.md](getting-started.md) | Cloning the repository, authenticating with GitHub when needed, entering a development shell, and running the app locally |
...
| [releasing.md](releasing.md) | Release posture, versioning expectations, and artifact verification |
