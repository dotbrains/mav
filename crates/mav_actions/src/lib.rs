...
// If the mav binary doesn't use anything in this crate, it will be optimized away
...
/// Opens a mav:// URL within the application.
#[derive(Clone, PartialEq, Deserialize, JsonSchema, Action)]
#[action(namespace = mav)]
#[serde(deny_unknown_fields)]
pub struct OpenMavUrl {
    pub url: Arc<str>,
}
...
#[action(namespace = mav, no_json, no_register)]
...
actions!(
    ...
    [
        ...
        #[action(deprecated_aliases = ["mav_actions::OpenSettingsEditor"])]
        OpenSettings,
        /// Opens the settings JSON file.
        #[action(deprecated_aliases = ["mav_actions::OpenSettings"])]
        OpenSettingsFile,
        /// Opens project-specific settings.
        #[action(deprecated_aliases = ["mav_actions::OpenProjectSettings"])]
        OpenProjectSettings,
        /// Opens the default keymap file.
        OpenDefaultKeymap,
        /// Opens the user keymap file.
        #[action(deprecated_aliases = ["mav_actions::OpenKeymap"])]
        OpenKeymapFile,
        /// Opens the keymap editor.
        #[action(deprecated_aliases = ["mav_actions::OpenKeymapEditor"])]
        OpenKeymap,
...
pub struct CreateWorktree {
    /// When this is None, Mav will randomly generate a worktree name.
...
pub mod feedback {
    ...
    actions!(
        feedback,
        [
            /// Opens email client to send feedback to Mav support.
            EmailMav,
