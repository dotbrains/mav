...
pub struct EditPredictionSettingsContent {
    ...
    /// Controls whether Mav may collect training data when using Mav's Edit Predictions.
...
/// Controls whether Mav collects training data when using Mav's Edit Predictions.
#[derive(
    Copy,
    Clone,
    Debug,
...
pub enum EditPredictionDataCollectionChoice {
    ...
    #[default]
    Default,
    /// Allow Mav to collect training data from open-source projects.
    Yes,
...
pub struct LanguageSettingsContent {
    ...
    /// Mav's Prettier integration settings.
    ...
    /// when you type '(', Mav will automatically add a closing ')' at the correct position.
    ///
    /// Default: true
    pub use_autoclose: Option<bool>,
    /// Whether to automatically surround text with characters for you. For example,
    /// when you select text and type '(', Mav will automatically surround text with ().
    ///
    /// Default: true
...
#[serde(rename_all = "snake_case")]
pub enum Formatter {
    /// Format files using Mav's Prettier integration (if applicable),
    /// or falling back to formatting via language server.
    #[default]
    Auto,
    /// Do not format code.
    None,
    /// Format code using Mav's Prettier integration.
    Prettier,
...
pub struct LanguageTaskSettingsContent {
    ...
    pub enabled: Option<bool>,
    /// Use LSP tasks over Mav language extension ones.
    /// If no LSP tasks are returned due to error/timeout or regular execution,
    /// Mav language extension tasks will be used instead.
    ///
    /// Other Mav tasks will still be shown:
    /// * Mav task from either of the task config file
    /// * Mav task from history (e.g. one-off task was spawned before)
