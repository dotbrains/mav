...
pub struct AgentSettingsContent {
    ...
    /// Command to automatically run when Mav creates a Terminal Thread shell in the agent panel.
    ...
    /// external agent's permission system is only used when Mav would allow
...
pub struct SandboxPermissionsContent {
    ...
    /// to without prompting. Paths written by Mav are absolute.
    /// Default: []
