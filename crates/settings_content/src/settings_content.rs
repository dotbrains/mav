...
pub struct SettingsContent {
    ...
    /// This base keymap settings adjusts the default keybindings in Mav to be similar
    /// to other common code editors. By default, Mav's keymap closely follows VSCode's
    ...
    // Settings related to calls in Mav
    pub calls: Option<CallSettingsContent>,

    /// Settings for the which-key popup.
    pub which_key: Option<WhichKeySettingsContent>,

    /// Settings related to Vim mode in Mav.
...
/// diagnostic data about a running Mav instance.
#[with_fallible_options]
...
pub enum ProfileBase {
    ...
    #[default]
    User,
    /// Apply profile settings on top of Mav's default settings, ignoring user customizations.
    Default,
}
...
pub struct SettingsProfile {
    ...
    /// - `default`: Apply on top of Mav's default settings, ignoring user customizations
    #[serde(default)]
...
pub struct TelemetrySettingsContent {
    ...
    /// Send anonymized usage data like what languages you're using Mav with.
    ///
    /// Default: true
...
pub struct DebuggerSettingsContent {
    ...
    /// Whether the breakpoints should be reused across Mav sessions.
    ///
    /// Default: true
    ...
    /// Whether to log messages between active debug adapters and Mav
    ///
    /// Default: true
...
/// Configuration of voice calls in Mav.
#[with_fallible_options]
#[derive(Clone, PartialEq, Default, Serialize, Deserialize, JsonSchema, MergeFrom, Debug)]
...
pub struct FileFinderSettingsContent {
    ...
    /// Only the file Mav had indexed will be used, not necessary all the gitignored files.
    ///
    /// Default: Smart
...
pub enum IncludeIgnoredContent {
    ...
    All,
    /// Use only the files Mav had indexed
    Indexed,
...
pub struct RemoteSettingsContent {
    ...
    ///
    /// When unset, Mav auto-detects BuildKit by probing for the `buildx` CLI
...
pub struct SshConnection {
    ...
    // By default Mav will download the binary to the host directly.
    // If this is set to true, Mav will download the binary to your local machine,
