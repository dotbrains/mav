//! Undo manager for project-panel filesystem operations.
//!
//! See `docs/project-panel-undo.md` for the history model, operation/result
//! mapping, and concurrency notes.
