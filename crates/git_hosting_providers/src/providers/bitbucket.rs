...
mod tests {
    ...
    fn test_build_bitbucket_self_hosted_permalink() {
        let permalink =
            Bitbucket::from_remote_url("git@bitbucket.company.com:mav-industries/mav.git")
                .unwrap()
                .build_permalink(
                    ParsedGitRemote {
                        owner: "mav-industries".into(),
        ...
        let expected_url = "https://bitbucket.company.com/projects/mav-industries/repos/mav/browse/main.rs?at=f00b4r";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_bitbucket_permalink_with_multi_line_selection() {
        ...
        let expected_url =
            "https://bitbucket.org/mav-industries/mav/src/f00b4r/main.rs#lines-24:48";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
