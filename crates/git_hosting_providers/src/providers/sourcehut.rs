...
mod tests {
    ...
    fn test_parse_remote_url_given_ssh_url() {
        let parsed_remote = SourceHut::public_instance()
            .parse_remote_url("git@git.sr.ht:~mav-industries/mav")
            .unwrap();
    ...
    fn test_parse_remote_url_given_ssh_url_with_git_suffix() {
        let parsed_remote = SourceHut::public_instance()
            .parse_remote_url("git@git.sr.ht:~mav-industries/mav.git")
            .unwrap();
    ...
    fn test_parse_remote_url_given_https_url() {
        let parsed_remote = SourceHut::public_instance()
            .parse_remote_url("https://git.sr.ht/~mav-industries/mav")
            .unwrap();
    ...
    fn test_parse_remote_url_given_self_hosted_ssh_url() {
        let remote_url = "git@sourcehut.org:~mav-industries/mav";
    ...
    fn test_parse_remote_url_given_self_hosted_ssh_url_with_git_suffix() {
        let remote_url = "git@sourcehut.org:~mav-industries/mav.git";
    ...
    fn test_parse_remote_url_given_self_hosted_https_url() {
        let remote_url = "https://sourcehut.org/~mav-industries/mav";
    ...
    fn test_build_sourcehut_permalink() {
        ...
        let expected_url = "https://git.sr.ht/~mav-industries/mav/tree/faa6f979be417239b2e070dbbf6392b909224e0b/item/crates/editor/src/git/permalink.rs";
    ...
    fn test_build_sourcehut_permalink_with_git_suffix() {
        ...
        let expected_url = "https://git.sr.ht/~mav-industries/mav.git/tree/faa6f979be417239b2e070dbbf6392b909224e0b/item/crates/editor/src/git/permalink.rs";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }

    #[test]
    fn test_build_sourcehut_self_hosted_permalink() {
        let permalink = SourceHut::from_remote_url("https://sourcehut.org/~mav-industries/mav")
            .unwrap()
            .build_permalink(
                ParsedGitRemote {
                    owner: "mav-industries".into(),
        ...
        let expected_url = "https://sourcehut.org/~mav-industries/mav/tree/faa6f979be417239b2e070dbbf6392b909224e0b/item/crates/editor/src/git/permalink.rs";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }

    #[test]
    fn test_build_sourcehut_self_hosted_permalink_with_git_suffix() {
        let permalink = SourceHut::from_remote_url("https://sourcehut.org/~mav-industries/mav.git")
            .unwrap()
            .build_permalink(
                ParsedGitRemote {
                    owner: "mav-industries".into(),
        ...
        let expected_url = "https://sourcehut.org/~mav-industries/mav.git/tree/faa6f979be417239b2e070dbbf6392b909224e0b/item/crates/editor/src/git/permalink.rs";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_sourcehut_permalink_with_single_line_selection() {
        ...
        let expected_url = "https://git.sr.ht/~mav-industries/mav/tree/faa6f979be417239b2e070dbbf6392b909224e0b/item/crates/editor/src/git/permalink.rs#L7";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_sourcehut_permalink_with_multi_line_selection() {
        ...
        let expected_url = "https://git.sr.ht/~mav-industries/mav/tree/faa6f979be417239b2e070dbbf6392b909224e0b/item/crates/editor/src/git/permalink.rs#L24-48";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_sourcehut_self_hosted_permalink_with_single_line_selection() {
        ...
        let expected_url = "https://sourcehut.org/~mav-industries/mav/tree/faa6f979be417239b2e070dbbf6392b909224e0b/item/crates/editor/src/git/permalink.rs#L7";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_sourcehut_self_hosted_permalink_with_multi_line_selection() {
        ...
        let expected_url = "https://sourcehut.org/~mav-industries/mav/tree/faa6f979be417239b2e070dbbf6392b909224e0b/item/crates/editor/src/git/permalink.rs#L24-48";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
}
