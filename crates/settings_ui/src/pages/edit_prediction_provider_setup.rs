...
#[path = "edit_prediction_provider_setup/provider_settings.rs"]
mod provider_settings;
use provider_settings::{codestral_settings, ollama_settings, open_ai_compatible_settings};
                ...
                .child(
                    v_flex()
                        ...
                        .when_some(env_var_name, |this, env_var_name| {
                            this.child({
                                let label = format!(
                                    "Or set the {} env var and restart Mav.",
                                    env_var_name.as_ref()
                                );
