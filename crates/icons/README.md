...
Icons are a big part of Mav, and they're how we convey hundreds of actions without relying on labeled buttons.
...
Then, they're modified, adjusted, cleaned up, and simplified depending on their use and overall fit with Mav.
...
Make sure to tag a member of Mav's design team (@mav-industries/design) so we can review and adjust any newly introduced icon.
