...
pub use display::RequestCanceled;
pub use notification_subscription::NotificationSubscription;
use notification_subscription::NotificationSubscriptionSet;
...
impl Client {
    ...
    pub fn on_notification(
        ...
        NotificationSubscription::new(self.subscription_set.clone(), method, f)
    }
}
