...
use anthropic::{ANTHROPIC_API_URL, AnthropicModelMode};
use anyhow::Result;
use collections::BTreeMap;
use credentials_provider::CredentialsProvider;
use gpui::{AnyView, App, Context, Entity, Task};
...
use language_model::{
    ...
    LanguageModelProviderState, ModelMode, ProviderConfigurationView, env_var,
};
...
pub struct AnthropicSettings {
    pub api_url: String,
    /// Extend Mav's list of Anthropic models.
