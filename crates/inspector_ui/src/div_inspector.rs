...
const MAV_INSPECTOR_STYLE_JSON: &str = util_macros::path!("/mav-inspector-style.json");

#[path = "div_inspector/render.rs"]
mod render;
use render::{
    RustStyleCompletionProvider, STYLE_METHODS, guess_rust_code_from_style, is_not_identifier_char,
};
        ...
        cx.spawn_in(window, {
            ...
            async move |this, cx| {
                ...
                let json_style_buffer =
                    Self::create_buffer_in_project(MAV_INSPECTOR_STYLE_JSON, &project, cx).await;
