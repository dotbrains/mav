    ...
    pub fn new<S: KernelSession + 'static>(
        ...
        window.spawn(cx, async move |cx| {
            ...
            let connection_info = ConnectionInfo {
                ...
                kernel_name: Some(format!("mav-wsl-{}", kernel_specification.name)),
            };
            ...
            let connection_path = runtime_dir.join(format!("kernel-mav-wsl-{entity_id}.json"));
...
pub use specifications::wsl_kernel_specifications;
