...
//!   (still using Mav's shipped default content) are skipped so we don't
...
//! downgrades to a Mav build without skills support won't lose anything.
...
///    built-ins are skipped so we don't write Mav's shipped default text
