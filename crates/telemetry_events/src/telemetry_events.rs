//! See [Telemetry in Mav](https://mav.dev/docs/telemetry) for additional information.
...
pub struct EventRequestBody {
    /// Identifier unique to each system Mav is installed on
    pub system_id: Option<String>,
    /// Identifier unique to each Mav installation (differs for stable, preview, dev)
    pub installation_id: Option<String>,
    /// Identifier unique to each logged in Mav user (randomly generated on first sign in)
    /// Identifier unique to each Mav session (differs for each time you open Mav)
    pub session_id: Option<String>,
    pub metrics_id: Option<String>,
    /// True for Mav staff, otherwise false
    ...
    /// Mav release channel (stable, preview, dev)
