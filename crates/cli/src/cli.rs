...
/// When Mav started not as an *.app but as a binary (e.g. local development),
...
pub const FORCE_CLI_MODE_ENV_VAR_NAME: &str = "MAV_FORCE_CLI_MODE";

/// Abstracts the transport for sending CLI responses (Mav → CLI).
///
