...
#[cfg(test)]
pub mod tests {
    mod cache_update_tests;
    mod edit_multibuffer_tests;
    mod excerpt_removal_tests;
    mod invalidation_race_tests;
    mod large_buffer_tests;
    mod large_multibuffer_tests;
    mod multi_language_tests;
    mod request_cancellation_tests;
    mod same_place_tests;
    mod scroll_refresh_tests;
    mod settings_tests;
    mod toggle_tests;
    mod unrelated_file_tests;
