...
pub(super) struct BranchColor(u8);
...
pub(super) type ActiveLaneIdx = usize;
...
pub(super) struct CommitLineKey {
    child: Oid,
    parent: Oid,
}

pub(super) struct GraphData {
    pub(super) lane_states: SmallVec<[LaneState; 8]>,
    pub(super) lane_colors: HashMap<ActiveLaneIdx, BranchColor>,
    pub(super) parent_to_lanes: HashMap<Oid, SmallVec<[usize; 1]>>,
    pub(super) next_color: BranchColor,
    pub(super) accent_colors_count: usize,
    ...
    pub(super) active_commit_lines: HashMap<CommitLineKey, usize>,
    pub(super) active_commit_lines_by_parent: HashMap<Oid, SmallVec<[usize; 1]>>,
}
