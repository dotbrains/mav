...
pub fn register(workspace: &mut Workspace) {
    workspace.register_action(|workspace, _: &mav_actions::git::Branch, window, cx| {
        open_with_tab(workspace, GitPickerTab::Branches, window, cx);
    });
    workspace.register_action(|workspace, _: &mav_actions::git::Switch, window, cx| {
        open_with_tab(workspace, GitPickerTab::Branches, window, cx);
    });
    workspace.register_action(
        |workspace, _: &mav_actions::git::CheckoutBranch, window, cx| {
            open_with_tab(workspace, GitPickerTab::Branches, window, cx);
        },
    );
    workspace.register_action(|workspace, _: &mav_actions::git::ViewStash, window, cx| {
        open_with_tab(workspace, GitPickerTab::Stashes, window, cx);
    });
}
