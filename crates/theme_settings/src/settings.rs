...
use gpui::{Font, FontStyle, Pixels, SharedString};
use refineable::Refineable;
use schemars::JsonSchema;
use serde::{Deserialize, Serialize};
pub use settings::{FontFamilyName, IconThemeName, ThemeAppearanceMode, ThemeName};
use settings::{IntoGpui, RegisterSetting, SettingsContent};
use std::sync::Arc;
...
mod font;
use font::font_fallbacks_from_settings;
pub use font::{
    AgentBufferFontSize, AgentUiFontSize, GitCommitBufferFontSize, MarkdownPreviewFontSize,
    ...
    adjusted_font_size, clamp_font_size, observe_buffer_font_size_adjustment,
