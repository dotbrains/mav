...
//! pipeline. Mav opts into that pipeline during rendering, then keeps
...
//! - [`postprocess`] the SVG to add Mav theme and accent styling.
//!
//! Mav's postprocessing is split up into stages. We parse the generated SVG
...
//! `player_colors` in the Mav theme.
//!
...
/// from Mav's UI palette) round-trip without silently losing their alpha.
