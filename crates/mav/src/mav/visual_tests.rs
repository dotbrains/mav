...
//! Visual testing infrastructure for Mav.
//!
//! This module provides utilities for visual regression testing of Mav's UI.
//! It allows capturing screenshots of the real Mav application window and comparing
...
//! cargo test -p mav visual_tests -- --ignored --test-threads=1
//!
//! # Update baselines when UI intentionally changes
//! UPDATE_BASELINES=1 cargo test -p mav visual_tests -- --ignored --test-threads=1
//! ```
//!
//! ## Screenshot Output
//!
...
/// Initialize a visual test context with all necessary Mav subsystems.
