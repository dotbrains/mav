...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Mav Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Mav Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Mav Editor Preview Instance Running",
        ReleaseChannel::Stable => "Mav Editor Stable Instance Running",
    }
}
