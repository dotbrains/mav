...
use mav_actions::{agent::AddSelectionToThread, assistant::InlineAssist, outline::ToggleOutline};
...
impl Render for QuickActionBar {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let editor_settings_dropdown = self.render_editor_settings_dropdown(
            editor.downgrade(),
