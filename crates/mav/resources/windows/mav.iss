...
AppPublisher=Mav Industries
AppPublisherURL=https://www.mav.dev/
AppSupportURL=https://www.mav.dev/
AppUpdatesURL=https://www.mav.dev/
...
[Files]
Source: "{#ResourcesDir}\Mav.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
; URI Scheme
Root: HKCU; Subkey: "Software\Classes\mav"; ValueType: "string"; ValueData: "URL:mav Protocol"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\mav"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCU; Subkey: "Software\Classes\mav\DefaultIcon"; ValueType: "string"; ValueData: "{app}\Mav.exe,1"
Root: HKCU; Subkey: "Software\Classes\mav\shell\open\command"; ValueType: "string"; ValueData: """{app}\Mav.exe"" ""%1"""
...
begin
  if WizardIsTaskSelected('addcontextmenufiles') then begin
    ShellExec('', 'powershell.exe', '-Command ' + AddQuotes('Add-AppxPackage -Path ''' + ExpandConstant('{app}\appx\mav_explorer_command_injector.appx') + ''' -ExternalLocation ''' + ExpandConstant('{app}\appx') + ''''), '', SW_HIDE, ewWaitUntilTerminated, AddAppxPackageResultCode);
