...
use gpui::{App, Task};
use language_model::{
    LanguageModelProviderId, LanguageModelToolResultContent, MAV_CLOUD_PROVIDER_ID,
};
...
impl AgentTool for WebSearchTool {
    ...
    /// We currently only support Mav Cloud as a provider.
    fn supports_provider(provider: &LanguageModelProviderId) -> bool {
        provider == &MAV_CLOUD_PROVIDER_ID
    }
